(function(f) {
    ...
    Share = function(t) {
        ...
        return extend(e, t), e.prototype.setup = function(t, e) {
            var o, n, i, r, s;
            for (r = document.querySelectorAll(t), this.extend(this.config, e, !0), this.set_global_configuration(), this.normalize_network_configuration(), this.config.ui.icon_font && this.inject_icons(), this.config.ui.button_font && this.inject_fonts(), this.config.networks.facebook.enabled && this.config.networks.facebook.load_sdk && this.inject_facebook_sdk(), n = o = 0, s = r.length; s > o; n = ++o) i = r[n], this.setup_instance(t, n)
        }, e.prototype.setup_instance = function(t, e) {
            var o, n, i, r, s, c, l, a, p;
            for (r = document.querySelectorAll(t)[e], this.hide(r), this.add_class(r, "sharer-" + e), r = document.querySelectorAll(t)[e], this.inject_css(r), this.inject_html(r), this.show(r), s = r.getElementsByTagName("label")[0], n = r.getElementsByClassName("social")[0], a = r.getElementsByTagName("li"), this.add_class(n, "networks-" + this.config.enabled_networks), s.addEventListener("click", function(t) {
                    return function() {
                        return t.event_toggle(n)
                    }
                }(this)), o = this, p = [], e = i = 0, c = a.length; c > i; e = ++i) l = a[e], p.push(l.addEventListener("click", function() {
            ...
            var e, o, n, i, r, s, c;
            for (s = document.querySelectorAll(this.element), c = [], n = o = 0, r = s.length; r > o; n = ++o) i = s[n], e = i.getElementsByClassName("social")[0], c.push(this["event_" + t](e));
            return c
