...
gulp.task('scripts', () =>
    gulp.src([
      ...
      './app/scripts/lib/highlight.min.js',
      './bower_components/jquery/dist/jquery.min.js',
      './app/scripts/share.js',
      './app/scripts/highlightinit.js'
    ])
...
gulp.task('clean', () => del(['.tmp', 'dist/*', 'static/*', '!dist/.git'], {dot: true}));

// Build production files, the default task - removed, lint, html. Added fonts.
gulp.task('default', ['clean'], cb =>
  runSequence(
    'styles',
    ['scripts', 'images', 'fonts', 'copy'],
...
gulp.task('serve', ['hugothegreat', 'scripts', 'styles'], () => {
  browserSync({
    notify: false,
